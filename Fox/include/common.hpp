...
namespace fox
{
	...
	namespace ecs
	{
        ...
        const std::uint32_t OnNativeScriptInit = "fox::ecs::OnNativeScriptInit"_hash;
        const std::uint32_t OnTransformInit = "fox::ecs::OnTransformInit"_hash;
	}

	namespace game
	{
		const std::uint32_t OnStart = "fox::game::OnStart"_hash;
		const std::uint32_t CameraBegin = "fox::game::CameraBegin"_hash;
		const std::uint32_t CameraDraw = "fox::game::CameraDraw"_hash;
		const std::uint32_t CameraEnd = "fox::game::CameraEnd"_hash;
	}
