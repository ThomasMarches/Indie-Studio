...
void UpdateKeys(OptionPauseScene *scene, fox::Application &app)
{
    fox::Entity e;
...
OptionPauseScene::OptionPauseScene() : fox::Scene() {}

OptionPauseScene::OptionPauseScene(const std::string &name) : fox::Scene(name)
{
}

OptionPauseScene::~OptionPauseScene() { }

void OptionPauseScene::on_create(fox::Application& app) { }

void OptionPauseScene::on_enable(fox::Application& app) {
...
void OptionPauseScene::on_destroy(fox::Application& app) { }

void OptionPauseScene::on_update(fox::Application& app)
{
    int save = 0;
    fox::Entity e;
...
void OptionPauseScene::on_disable(fox::Application& app)
{
